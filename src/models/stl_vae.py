...
class VariationalAutoencoder(object):
    ...
    def train(self, generator, training_epochs=10, display_step=1, save_step=5):
        # Training cycle
        for epoch_num, epoch in enumerate(range(training_epochs)):
            ...
            if epoch % save_step == 0:
                ...
                save_path = saver.save(sess, os.path.join(self.ckpt_dir, "model_epoch-{}.ckpt".format(epoch)))
